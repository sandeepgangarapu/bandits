...
true_means = c(0.25, 2.82, 1.48, 4.95, 3)

true_vars = c(3.84,  1.97, 2.62, 1, 4.06)
...
regret_plot <- ggplot(df %>% filter(alg == main_algs)) + geom_point(aes(x=x, y=factor(group)), shape=1, alpha=0.6) +
  facet_grid(alg ~.) +
  theme_bw() +
