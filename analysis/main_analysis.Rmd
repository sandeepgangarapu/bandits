...
non_agg_data <- fread("non_agg_analysis_default_100_20000.csv")
# remove NA's
non_agg_data <- non_agg_data[complete.cases(non_agg_data),]
non_agg_data <- non_agg_data[, alg := ifelse(alg=="ab", "ABTesting", ifelse(alg=="thomp","THOMP", ifelse(alg=="thomp_inf", "THOMP_INF", ifelse(alg=="thomp_athey", "HADAD", NA))))]
