...
if __name__ == '__main__':
    ...
    print(arm_vars)
    outcome_lis_of_lis = create_distributions_custom(arm_means=arm_means,
                                                     arm_vars=arm_vars,
    ...
    ucb_bandit = ucb_naive(bandit=ucb_bandit,
                           num_rounds=len(outcome_lis_of_lis[0]*10),
                           num_arms=num_arms)
    ...
    df1.columns = ["ab_regret", "peek_regret", "ucb_regret", "mix_regret",
                   "ab_mean_rmse", "ab_var_rmse",
